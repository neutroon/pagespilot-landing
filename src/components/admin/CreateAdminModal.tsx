...
export default function CreateAdminModal({
  ...
  const validateForm = () => {
    ...
    if (!confirmAdmin) {
      newErrors.confirmAdmin = "You must confirm admin creation";
    }
      ...
      <div className="bg-white rounded-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-10 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <ul className="text-xs text-red-700 mt-1 space-y-1">
                    ...
                    <li>• Can manage all users and managers</li>
                    <li>• Can access all analytics and data</li>
                    <li>• Can modify system settings</li>
                    <li>• Can create other admins</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="flex space-x-3 pt-6">
            ...
            <button
              type="submit"
              disabled={isLoading || !confirmAdmin}
